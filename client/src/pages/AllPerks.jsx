...
export default function AllPerks() {
  ...
  // ------------------- EFFECT: Load all perks on initial mount -------------------
  useEffect(() => {
    loadAllPerks()
  }, [])

  // ------------------- EFFECT: Update unique merchants whenever perks change -------------------
  useEffect(() => {
  ...
  // ------------------- EFFECT: Auto-search when searchQuery or merchantFilter changes -------------------
  useEffect(() => {
    // Only trigger auto-search if the user typed something or selected a merchant
    // You can add a small debounce here if desired
    loadAllPerks()
